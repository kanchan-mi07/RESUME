...
import ProfessionslSummaryForm from "../Components/ProfessionslSummaryForm";
...
const ResumeBuilder = () => {
  ...
  const handleShare = async () => {
    const shareLink = `${window.location.origin}/view/${resumeId}`;

    try {
      await navigator.clipboard.writeText(shareLink);
      toast.success("Link copied to clipboard!");
    } catch (error) {
      toast.error("Clipboard error:", error);
    }
  };
